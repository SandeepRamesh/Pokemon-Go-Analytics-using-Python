...
with open('../counts_size_android.json', 'r') as a:
    android_time_stamps = json.load(a)
with open('../counts_size_ios.json','r') as i:
...
# Predicting for Total rating for Android on 1st November 2016 23:50hrs using last value of 31st october 2016
...
# Predicting for Total rating for Ios on 1st November 2016 23:50hrs using last value of 31st october 2016
